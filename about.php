		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="active"><a href="about.html">Extracted Named Entities</a></li>
					<!--<li class="dropdown">
		...
		<div class="row">
			...
			<article class="col-sm-8 maincontent">
				<header class="page-header">
					<h1 class="page-title">Article & Named Entities are as follows:</h1>
				</header>
			<?php
				echo "<br>Query Document:<br><br>";
				...
				<div class="row">
					...
					<div class="col-md-3 widget">
						...
						<div class="widget-body">
							<p>+91-779-909-7290<br>
								<a href="mailto:#">shivani.poddar92@gmail.com</a><br>
								<br>
								IIIT Hyderabad
							</p>	
						</div>
					...
					<div class="col-md-6 widget">
						<h3 class="widget-title">Project Made as a part of</h3>
						<div class="widget-body">
						<p>
						Information Extraction and Retrieval Course, IIIT Hyderabad.
						</div>
					</div>
